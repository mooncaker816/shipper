...
type VesselServiceClient interface {
	...
	GetAll(ctx context.Context, in *Specification, opts ...client.CallOption) (*Response, error)
}
...
func (c *vesselServiceClient) GetAll(ctx context.Context, in *Specification, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.serviceName, "VesselService.GetAll", in)
	out := new(Response)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
type VesselServiceHandler interface {
	...
	GetAll(context.Context, *Specification, *Response) error
}
...
func (h *VesselService) GetAll(ctx context.Context, in *Specification, out *Response) error {
	return h.VesselServiceHandler.GetAll(ctx, in, out)
}
...
var fileDescriptor0 = []byte{
	...
	,
}
